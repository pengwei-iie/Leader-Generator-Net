...
def preprocess_EXIM_data(inputdir,
                         targetdir,
                         lowercase=False,
                         ...
                         eos=None):
    """
    Preprocess the data from the EXIM corpus so it can be used by the
    ESIM model.
...
if __name__ == "__main__":
    default_config = "../config/exim_preprocessing.json"

    parser = argparse.ArgumentParser(description="Preprocess the EXIM dataset")
    parser.add_argument(
        "--config",
        default=default_config,
        help="Path to a configuration file for preprocessing EXIM"
    )
